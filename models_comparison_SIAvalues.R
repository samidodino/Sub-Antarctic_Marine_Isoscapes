#### Paper Isoscapes Riccialdelli et al. 2024 - Progresss in Oceanography -under review ####
## Generalized Least Square (GLS) models to compare between SIA values. Global, Regional and Local approaches ###
...
# For  nitrogen
shapiro.test(global_zoo$d15N[global_zoo$MarineArea == "1_BC"])#normal
hist(global_zoo$d15N[global_zoo$MarineArea == "1_BC"])
shapiro.test(global_zoo$d15N[global_zoo$MarineArea == "2_CA"])
hist(global_zoo$d15N[global_zoo$MarineArea == "2_CA"])
shapiro.test(global_zoo$d15N[global_zoo$MarineArea == "3_BB"])#normal
shapiro.test(global_zoo$d15N[global_zoo$MarineArea == "4_PFZ"])#normal
shapiro.test(global_zoo$d15N[global_zoo$MarineArea == "5_PW"])#normal

global_zoo_d15N<-lm(d15N~MarineArea,data=global_zoo, na.action=na.fail)
global_zoo_d15N
plot(global_zoo_d15N)#qqplot normal

#For Carbon
shapiro.test(global_zoo$d13Cs[global_zoo$MarineArea == "1_BC"])#normal
hist(global_zoo$d13Cs[global_zoo$MarineArea == "1_BC"])
shapiro.test(global_zoo$d13Cs[global_zoo$MarineArea == "2_CA"])
hist(global_zoo$d13Cs[global_zoo$MarineArea == "2_CA"])
shapiro.test(global_zoo$d13Cs[global_zoo$MarineArea == "3_BB"])#normal
shapiro.test(global_zoo$d13Cs[global_zoo$MarineArea == "4_PFZ"])#normal
shapiro.test(global_zoo$d13Cs[global_zoo$MarineArea == "5_PW"])#normal

global_zoo_d13C<-lm(d13Cs~MarineArea,data=global_zoo, na.action=na.fail)
global_zoo_d13C
plot(global_zoo_d13C)#qqplot normal
...
M.gls1<-gls(d13Cs~MarineArea,weights = vf2, data=global_zoo, method="ML", na.action=na.fail)
summary(M.gls1)
dredge(M.gls1)
confint(M.gls1)
...
range(global_zoo$d13Cs[global_zoo$MarineArea == "1_BC"])
range(global_zoo$d13Cs[global_zoo$MarineArea == "2_CA"])
range(global_zoo$d13Cs[global_zoo$MarineArea == "3_BB"])
range(global_zoo$d13Cs[global_zoo$MarineArea == "4_PFZ"])
range(global_zoo$d13Cs[global_zoo$MarineArea == "5_PW"])

sum(global_zoo$d13Cs & global_zoo$MarineArea == "1_BC")
sum(global_zoo$d13Cs & global_zoo$MarineArea == "2_CA")
sum(global_zoo$d13Cs & global_zoo$MarineArea == "3_BB")
sum(global_zoo$d13Cs & global_zoo$MarineArea == "4_PFZ")
sum(global_zoo$d13Cs & global_zoo$MarineArea == "5_PW")


## posthoc test for multiple comparisons 

global_zoo <- as.data.frame(global_zoo)

games_howell_test(data=global_zoo, d13Cs~MarineArea, conf.level = 0.95, detailed = FALSE)
...
cor.test(global_zoo$Lat,global_zoo$Chla_sat_2)# no correlac
cor.test(global_zoo$Long,global_zoo$Chla_sat_2)# no correlac

cor.test(global_zoo$Lat,global_zoo$SST_sat_2)# correlac, r=0.91
cor.test(global_zoo$Long,global_zoo$SST_sat_2)# no correlac

cor.test(global_zoo$SST_sat_2,global_zoo$Chla_sat_2)# no correlac

cor.test(global_zoo$Lat,global_zoo$depth_mosaico)# no correlac
cor.test(global_zoo$Long,global_zoo$depth_mosaico)# no correlac
cor.test(global_zoo$Chla_sat_2,global_zoo$depth_mosaico)# no correlac
cor.test(global_zoo$SST_sat_2,global_zoo$depth_mosaico)# no correlac
...
global_zoo_no_na <- na.omit(global_zoo[, c("d15N","d13Cs", "SST_sat_2", "Long", "depth_mosaico", "Chla_sat_2", "MarineArea")])

M.gls1.2 <- gls(d13Cs ~ SST_sat_2 + Long + Chla_sat_2 + depth_mosaico, weights = vf2, data = global_zoo_no_na, method = "ML",na.action = na.fail)
summary(M.gls1.2)
...
#Nitrogen
shapiro.test(global_EUFA$d15N[global_EUFA$MarineArea == "1_BC"])#normal
shapiro.test(global_EUFA$d15N[global_EUFA$MarineArea == "2_CA"])#normal
shapiro.test(global_EUFA$d15N[global_EUFA$MarineArea == "3_BB"])#normal
shapiro.test(global_EUFA$d15N[global_EUFA$MarineArea == "4_PFZ"])#normal
shapiro.test(global_EUFA$d15N[global_EUFA$MarineArea == "5_PW"])#normal

global_eufa_d15N<-lm(d15N~MarineArea,data=global_EUFA, na.action=na.fail)
plot(global_eufa_d15N)#qqplot accept normality


#Carbon

shapiro.test(global_EUFA$d13Cs[global_EUFA$MarineArea == "1_BC"])#normal
shapiro.test(global_EUFA$d13Cs[global_EUFA$MarineArea == "2_CA"])#normal
shapiro.test(global_EUFA$d13Cs[global_EUFA$MarineArea == "3_BB"])#normal
shapiro.test(global_EUFA$d13Cs[global_EUFA$MarineArea == "4_PFZ"])#normal
shapiro.test(global_EUFA$d13Cs[global_EUFA$MarineArea == "5_PW"])#no normal, see qqplot

global_eufa_d13Cs<-lm(d13Cs~MarineArea,data=global_EUFA, na.action=na.fail)
plot(global_eufa_d13Cs)#qqplot accept normality
...
M.gls2.1<-gls(d15N~MarineArea,weights = vf2, data=global_EUFA, method="ML", na.action=na.fail)
summary(M.gls2.1)
anova(M.gls2.1, test = "F")

range(global_EUFA$d15N[global_EUFA$MarineArea == "1_BC"])
range(global_EUFA$d15N[global_EUFA$MarineArea == "2_CA"])
range(global_EUFA$d15N[global_EUFA$MarineArea == "3_BB"])
range(global_EUFA$d15N[global_EUFA$MarineArea == "4_PFZ"])
range(global_EUFA$d15N[global_EUFA$MarineArea == "5_PW"])

games_howell_test(data = global_EUFA, d15N ~ MarineArea, detailed = FALSE)


#Carbon 

M.gls1.1<-gls(d13Cs~MarineArea,weights = vf2, data=global_EUFA, method="ML", na.action=na.fail)
summary(M.gls1.1)
anova(M.gls1.1, test = "F")


range(global_EUFA$d13Cs[global_EUFA$MarineArea == "1_BC"])
sum(global_EUFA$d13Cs & global_EUFA$MarineArea == "1_BC")
range(global_EUFA$d13Cs[global_EUFA$MarineArea == "2_CA"])
sum(global_EUFA$d13Cs & global_EUFA$MarineArea == "2_CA")
range(global_EUFA$d13Cs[global_EUFA$MarineArea == "3_BB"])
sum(global_EUFA$d13Cs & global_EUFA$MarineArea == "3_BB")
range(global_EUFA$d13Cs[global_EUFA$MarineArea == "4_PFZ"])
sum(global_EUFA$d13Cs & global_EUFA$MarineArea == "4_PFZ")
range(global_EUFA$d13Cs[global_EUFA$MarineArea == "5_PW"])
sum(global_EUFA$d13Cs & global_EUFA$MarineArea == "5_PW")


global_EUFA <- as.data.frame(global_EUFA)

games_howell_test(data = global_EUFA, d13Cs ~ MarineArea, detailed = FALSE)

#### Models evaluating explanatory variables #####
## There are rows with some NAs in chla and sst satellite,
#We create a new object that does not contain NAs and includes all the columns that interest us

global_EUFA_no_na <- na.omit(global_EUFA[, c("d15N","d13Cs", "SST_sat_2","Lat", "Long", "depth_mosaico", "Chla_sat_2", "MarineArea")])
View(global_EUFA_no_na)

#evaluate correlations

cor.test(global_EUFA_no_na$Lat,global_EUFA_no_na$Chla_sat_2)# no correlac
cor.test(global_EUFA_no_na$Long,global_EUFA_no_na$Chla_sat_2)# no correlac
cor.test(global_EUFA_no_na$Lat,global_EUFA_no_na$SST_sat_2)# correlac, r=0.89
cor.test(global_EUFA_no_na$Long,global_EUFA_no_na$SST_sat_2)# no correlac
cor.test(global_EUFA_no_na$SST_sat_2,global_EUFA_no_na$Chla_sat_2)# no correlac
cor.test(global_EUFA_no_na$Lat,global_EUFA_no_na$depth_mosaico)# no correlac
cor.test(global_EUFA_no_na$Long,global_EUFA_no_na$depth_mosaico)# no correlac
cor.test(global_EUFA_no_na$Chla_sat_2,global_EUFA_no_na$depth_mosaico)# no correlac
cor.test(global_EUFA_no_na$SST_sat_2,global_EUFA_no_na$depth_mosaico)# no correlac

#Nitrogen
M.gls1.2.2 <- gls(d15N ~ SST_sat_2 + Long + Chla_sat_2 + depth_mosaico, weights = vf2, data = global_EUFA_no_na, method = "ML",na.action = na.fail)
summary(M.gls1.2.2)
...
#Carbon
M.gls1.1.2 <- gls(d13Cs ~ SST_sat_2 + Long + Chla_sat_2 + depth_mosaico, weights = vf2, data = global_EUFA_no_na, method = "ML",na.action = na.fail)
summary(M.gls1.1.2)
...
global_Amphi_Themi <- table %>%
  filter(SP_red %in% c("Amphipod", "Themi")& Season=="autumn")

#Nitrogen
shapiro.test(global_Amphi_Themi$d15N)#normality
global_amphithemi_d15N<-lm(d15N~MarineArea,data=global_Amphi_Themi, na.action=na.fail)
plot(global_amphithemi_d15N)

#Carbon
shapiro.test(global_Amphi_Themi$d13Cs)#normality
global_amphithemi_d13Cs<-lm(d13Cs~MarineArea,data=global_Amphi_Themi, na.action=na.fail)
plot(global_amphithemi_d13Cs)

# unbalanced groups, we model heterocedacea
vf2 <- varIdent(form= ~ 1 | MarineArea)

#Nitrogen 
M.gls2.1.1<-gls(d15N~MarineArea,weights = vf2, data=global_Amphi_Themi, method="ML", na.action=na.fail)
summary(M.gls2.1.1)
dredge(M.gls2.1.1)
confint(M.gls2.1.1)
anova(M.gls2.1.1, test = "F")

range(global_Amphi_Themi$d15N[global_Amphi_Themi$MarineArea == "1_BC"])
range(global_Amphi_Themi$d15N[global_Amphi_Themi$MarineArea == "2_CA"])
range(global_Amphi_Themi$d15N[global_Amphi_Themi$MarineArea == "3_BB"])
range(global_Amphi_Themi$d15N[global_Amphi_Themi$MarineArea == "4_PFZ"])
range(global_Amphi_Themi$d15N[global_Amphi_Themi$MarineArea == "5_PW"])

games_howell_test(data = global_Amphi_Themi, d15N ~ MarineArea, detailed = FALSE)

#Carbon
M.gls1.1.1<-gls(d13Cs~MarineArea,weights = vf2, data=global_Amphi_Themi, method="ML", na.action=na.fail)
summary(M.gls1.1.1)
dredge(M.gls1.1.1)
confint(M.gls1.1.1)
...
global_Amphi_Themi <- as.data.frame(global_Amphi_Themi)

games_howell_test(data = global_Amphi_Themi, d13Cs ~ MarineArea, detailed = FALSE)

range(global_Amphi_Themi$d13Cs[global_Amphi_Themi$MarineArea == "1_BC"])
sum(global_Amphi_Themi$d13Cs & global_Amphi_Themi$MarineArea == "1_BC")
range(global_Amphi_Themi$d13Cs[global_Amphi_Themi$MarineArea == "2_CA"])
sum(global_Amphi_Themi$d13Cs & global_Amphi_Themi$MarineArea == "2_CA")
range(global_Amphi_Themi$d13Cs[global_Amphi_Themi$MarineArea == "3_BB"])
sum(global_Amphi_Themi$d13Cs & global_Amphi_Themi$MarineArea == "3_BB")
range(global_Amphi_Themi$d13Cs[global_Amphi_Themi$MarineArea == "4_PFZ"])
sum(global_Amphi_Themi$d13Cs & global_Amphi_Themi$MarineArea == "4_PFZ")
range(global_Amphi_Themi$d13Cs[global_Amphi_Themi$MarineArea == "5_PW"])
sum(global_Amphi_Themi$d13Cs & global_Amphi_Themi$MarineArea == "5_PW")

#### Models evaluating explanatory variables #####
## There are rows with some NAs in chla and sst satellite,
#We create a new object that does not contain NAs and includes all the columns that interest us
global_AT_no_na <- na.omit(global_Amphi_Themi[, c("d15N","d13Cs", "SST_sat_2","Lat", "Long", "depth_mosaico", "Chla_sat_2", "MarineArea")])

#Correlations 
cor.test(global_AT_no_na$Lat,global_AT_no_na$Chla_sat_2)# no correlac
cor.test(global_AT_no_na$Long,global_AT_no_na$Chla_sat_2)# no correlac
cor.test(global_AT_no_na$Lat,global_AT_no_na$SST_sat_2)# correlac, r=0.93
cor.test(global_AT_no_na$Long,global_AT_no_na$SST_sat_2)# no correlac
cor.test(global_AT_no_na$SST_sat_2,global_AT_no_na$Chla_sat_2)# no correlac
cor.test(global_AT_no_na$Lat,global_AT_no_na$depth_mosaico)# no correlac
cor.test(global_AT_no_na$Long,global_AT_no_na$depth_mosaico)# no correlac
cor.test(global_AT_no_na$Chla_sat_2,global_AT_no_na$depth_mosaico)# no correlac
cor.test(global_AT_no_na$SST_sat_2,global_AT_no_na$depth_mosaico)# no correlac

#Nitrogen
M.gls1.3 <- gls(d15N ~ SST_sat_2 + Long + Chla_sat_2 + depth_mosaico, weights = vf2, data = global_AT_no_na, method = "ML",na.action = na.fail)
summary(M.gls1.3)
dredge(M.gls1.3)
coef(M.gls1.3)
confint(M.gls1.3)
tab_model(M.gls1.3)
#Carbon
M.gls1.1.1.2 <- gls(d13Cs ~ SST_sat_2 + Long + Chla_sat_2 + depth_mosaico, weights = vf2, data = global_AT_no_na, method = "ML",na.action = na.fail)
